# Разработка веб приложения «Планировщик проектов» на JavaSpring
...
- Отслеживание настроения: Приложение позволит пользователю оценивать выполение задач в ежедневном режиме, использовать разные шкалы (например, от 1 до 5 или отлично, хорошо, удовлетворительно, плохо, ужасно).
